...
public class UserProfile {
    ...
    public UserProfile(int theme, String userName, String firstName, String lastName, String jobTitle, String email,
            String website, String phoneNum, String summary) {
        this.theme = theme;
